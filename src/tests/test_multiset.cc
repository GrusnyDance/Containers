...
class TestMultiset {
 public:
  ...
  s21::multiset<int> s21_set_ten{1,  123, 123, 2, 56, 76, 123, 53, 78, 43,
                                 21, 1,   1,   1, 1,  53, 53,  76, 53, 100};
  std::multiset<int> std_set_ten{1,  123, 123, 2, 56, 76, 123, 53, 78, 43,
                                 21, 1,   1,   1, 1,  53, 53,  76, 53, 100};
  s21::multiset<int> s21_set_copy;
  std::multiset<int> std_set_copy;
  s21::multiset<int> s21_move;
  std::multiset<int> std_move;
  s21::multiset<int> s21_set_swap{95, 95, 95, 95, 94, 93,
                                  93, 93, 94, 94, 94, 92};
  std::multiset<int> std_set_swap{95, 95, 95, 95, 94, 93,
                                  93, 93, 94, 94, 94, 92};
